...
nemo-preview nemo-share xdg-user-dirs packagekit-qt5 wget powerdevil sddm-kcm systemsettings xdg-desktop-portal-kde gthumb gedit kdeconnect sshfs okular
